...
var result1 = terser.minify(fs.readFileSync(getPath('source/find.js'), 'utf8'), options);
var result2 = terser.minify(fs.readFileSync(getPath('source/require.js'), 'utf8'), options);
...
fs.writeFileSync(getPath('source/script.h'), scriptFind + '\n' + scriptRequire + '\n', 'utf8')
